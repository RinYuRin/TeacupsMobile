...
export default function SignUpScreen({ navigation }) {
  ...
  const handleSignUp = () => {
    console.log("Sign Up pressed with:", { email, password, confirmPassword, acceptTerms, acceptPolicy })
    if (password !== confirmPassword) {
      alert("Passwords do not match!")
      return
    }
    if (!acceptTerms || !acceptPolicy) {
      alert("You must accept both the Terms and Conditions and the Policy and Agreement!")
      return
    }
